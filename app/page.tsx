    ...
    <div className="space-y-6">
      ...
      {projects.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-slate-500 mb-4">No projects yet. Create one to start organizing your templates.</p>
          <ProjectForm />
        </div>
      ) : (
            ...
            {projects.map((p) => {
              ...
              return (
                <li key={p.id} className="flex items-center justify-between px-4 py-3">
                  <Link href={`/projects/${p.id}`} className="flex-1 hover:bg-slate-50 rounded px-2 py-1 -mx-2 -my-1">
